...
\begin{document}
  ...
  \begin{multicols}{2}
    ...
    {
      \begin{body1}
        Implemented software tools to aide in validation of the SoCs. 
        Developed code to validate the design of the memory logic block.
        Helped debug SoC failures and implemented code to maintain the validation platform software. 
      \end{body1}
    }
    \end{section}
    ...
    {
      \begin{body1}
        Worked on UI for an iPhone app using Sencha and javascript.
        Used Ruby on Rails and PostgreSQL for back-end.
        Implemented a REST based API to connect app and back-end using JSON for data exchange.
      \end{body1}
    }
    \end{section}
    ...
    {
      \begin{body1}
        Worked on a web based security monitor.
        Quickly picked up Python and Git on the job.
        Developed code to send and receive data over UNIX sockets and parse syslog messages using PLY.
        Developed a web app using Django to display and filter syslog messages.
      \end{body1}
    }
    \end{section}
