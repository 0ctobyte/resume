...
\begin{document}
  ...
  \begin{multicols}{2}
    ...
    {
      \begin{heading3}
        \textcolor{darkcyan}{4A Computer Engineering}
      \end{heading3}
    }
    \end{section}
    ...
    {
      \begin{body1}
        Implemented software tools to aide in validation of SoCs (System-on-a-Chip). 
        Developed code, in ARM assembly, to validate the design of the memory logic block.
    ...
    \begin{minipage}[t]{\columnwidth}
      ...
      \begin{heading3}
        \textcolor{darkcyan}{ogl}
      \end{heading3}

      \begin{body1}
        \url{http://github.com/0ctobyte/ogl}
      \end{body1}
      ...
      ]
      {
        \begin{body1}
          ...
          Renders model and materials as well applying textures specified by the Wavefront Object file. 
          Uses OpenGL 4.1 with GLSL shaders which perform phong and goraud shading.
          Implemented matrix and vector operations for vertex transformations.
        \end{body1}
      }
      \end{section}
      ...
      {
        \begin{body2}
          \textcolor{darkgray}{Computer Architecture \newline
            Computer Graphics \newline
